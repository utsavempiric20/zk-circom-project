...
contract PlonkVerifier {
    ...
    uint256 constant Qmx =
        20990191830837720527494340807739589262086102712434604083400452655059454678573;
    uint256 constant Qmy =
        18647423922844888074194188051881517601513127620043931838113199355518329593696;
    uint256 constant Qlx =
        6268063985689721945979422921915551255718807259014610924035445691347448572384;
    uint256 constant Qly =
        8829132262871029511766942340028089931860739719326108104547937473208962165728;
    uint256 constant Qrx =
        9463031745748937521317983200645261044468452287271941847013633945750425543151;
    uint256 constant Qry =
        3593905602582808631264619247748281746845812555003338080549201177671293403891;
    uint256 constant Qox =
        19694382524884129411700874930519592481057617449631654813158844138673457742519;
    uint256 constant Qoy =
        214275655551899278345824709457410249179785809608258372398481919531221091738;
    uint256 constant Qcx =
        6968328649643763857582957849596618646647169360414638926190061559963682679669;
    uint256 constant Qcy =
        4881908943749186689629436468110241697857213450814712937563681595927520417610;
    uint256 constant S1x =
        12471420456096652275866956254733337002557562923858555519746224834520149021829;
    uint256 constant S1y =
        8814463169518206775114241898031953834331224084307658859566143179583026956303;
    uint256 constant S2x =
        4710673491182190359735192053205831245485749460996967789691324357670279709379;
    uint256 constant S2y =
        9733098396776831396003195818192672017888060306029206478574016459841533011670;
    uint256 constant S3x =
        16954872562724571855634185013655479325585667956836630571136091152348538852819;
    uint256 constant S3y =
        15128960198520739940776074140912009158264341369326500849836180827024522120559;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 =
        21827965972585447744389867360959984138563633584509836556517176724064628054568;
    uint256 constant X2x2 =
        2398789640819007046251947724132445519027115609252432695083835934575485440873;
    uint256 constant X2y1 =
        3176802288568780740569196102263702091712697336151130519447448807871999321633;
    uint256 constant X2y2 =
        17245469766505602024668577873883147928080169581358726041092976262395359366459;
